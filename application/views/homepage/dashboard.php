                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class='col-md-6'>
                            <div class="box box-info">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Search Cases</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form class="form-group">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="odistrict" name="homepagedistrict" placeholder="Select District" required="true">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control">
                                                ...
                                                <option value="70">After the poll, causes hurt or assault and threatens to impose
                                                    Social or Economic boycott or prevents availing benefit of Public service
                                                </option>
                                                <option value="27">Begar or other forms of forced or bonded labour</option>
                                                <option value="67">Being a public servant wilful neglect of duties required to be
                                                    performed by him under SC/ST Act
                                                </option>
                                                <option value="73">By words either written or spoken Disrespects any late person
                                                    held in high esteem
                                                </option>

                                                <option value="52">By words either written or spoken or by signs promotes or
                                                    attempts to promote feelings of enmity, hatred or ill-will
                                                </option>

                                                <option value="65">Causes physical harm or mental agony on the allegation of
                                                    practicing witchcraft or being a witch
                                                </option>

                                                <option value="75">Commits mischief by fire (Arson) or any other explosive substance
                                                    causing damage to house, property or place of worship
                                                </option>

                                                <option value="71">Commits offence against Dalit/Adivasi person for having voted or
                                                    not having voted for a particular Candidate
                                                </option>

                                                <option value="28">Compels to dispose or carry human or animal carcasses, or to dig
                                                    graves
                                                </option>

                                                <option value="31">Corrupts or fouls the water of any spring, reservoir or any other
                                                    source
                                                </option>
                                                ...
                                                <option value="32">Denies customary right of passage to a place of public resort
                                                </option>
                                                <option value="17">Destroys damages or defiles any object generally known to be held
                                                    sacred or in high esteem
                                                </option>
                                                <option value="18">Discrimination or harassment or insult or denying or limiting
                                                    access to opportunities in any educational institutions, hospital, dispensary
                                                    and Primary Health centre
                                                </option>
                                                <option value="22">Dumps excreta, sewage, carcasses or any other obnoxious substance
                                                    in premises
                                                </option>
                                                <option value="57">Forces or causes to leave his house, village or other place of
                                                    residence
                                                </option>
                                                <option value="21">Forces to drink or eat such inedible or obnoxious substance
                                                </option>
                                                <option value="24">Forcible tonsuring of head, removing moustaches</option>
                                                <option value="69">Forcing not to vote or vote for a particular candidate, not to
                                                    file nomination or not to support nomination of a SC/ST Candidate
                                                </option>
                                                ...
                                                <option value="13">Imposes, blackmail or threatens a social or economic boycott of
                                                    any person or a family or a group
                                                </option>
                                                <option value="48">Institutes false, malicious or vexatious suit or criminal or
                                                    other legal proceedings against a member of SC/ST
                                                </option>
                                                <option value="49">Intentionally insults or intimidates with intent to humiliate
                                                </option>
                                                <option value="53">Intentionally touches a woman when such act of touching is of a
                                                    sexual nature and is without the recipient�s consent
                                                </option>
                                                <option value="41">Interference with the enjoyment of SC/ST rights including forest
                                                    rights, over any land or premises or water or irrigation facilities
                                                </option>
                                                <option value="47">Intimidates or obstructs a Chairperson or a holder of any other
                                                    office of a Panchayat from performing their normal duties and functions
                                                </option>
                                                <option value="3">Kidnapping &amp; Abduction</option>
                                                <option value="29">Manual scavenging or employs or permits the employment of such
                                                    member for such purpose
                                                </option>
                                                <option value="1">Murder</option>
                                                <option value="58">Obstructs or prevents using common property resources of an area,
                                                    or burial or cremation ground, any river, stream, spring, well, tank, cistern,
                                                    water-tap or other or any bathing ghat, road or passage
                                                </option>
                                                <option value="8">Other Crimes Against SCs</option>
                                                <option value="30">Performs, or promotes dedicating woman to a deity, idol, object
                                                    of worship, temple as a devdasi
                                                </option>
                                                <option value="64">Prevent practicing any profession trade or business or employment
                                                    in any job
                                                </option>
                                                <option value="59">Prevents mounting or riding bicycles or motor cycles or wearing
                                                    footwear or new clothes in public places
                                                </option>
                                                <option value="9">Protection of Civil Rights Act</option>
                                                <option value="16">Ransacking of house hold items and destruction of movable and
                                                    immovable property
                                                </option>
                                                <option value="2">Rape</option>
                                                <option value="11">Refusal to pay wages or contract wages</option>
                                                <option value="25">Removing clothes, painting face or body or any other similar
                                                    act
                                                </option>
                                                <option value="5">Robbery</option>
                                                <option value="10">SC/ST (POA) Act</option>
                                                <option value="61">TBD22</option>
                                                <option value="20">Uses words, acts or gestures of a sexual nature towards a woman
                                                </option>
                                                <option value="72">Using lawful power for causing injury or annoyance to a SC/ST
                                                    person
                                                </option>
