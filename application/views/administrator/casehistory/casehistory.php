                    ...
                    <div class="col-sm-6">
                        ...
                        <table id="showallNotices" class="table table-bordered table-striped dataTable" role="grid"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td width="50%" style="line-height: 10px"><b><?= $this->lang->line('mobile_number') ?></b></td>
                                    <td width="50%"
                    ...
                    <div class="col-sm-6">
                        ...
                        <table id="showallNotices" class="table table-bordered table-striped dataTable" role="grid"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td width="50%" style="line-height: 10px"><b><?= $this->lang->line('offender_address') ?></b></td>
                                ...
                                <div class="box box-solid">
                                    <div class="box-header with-border">
                                        ...
                                        <h3 
                                            ...
                                            class="box-title"><?= $this->lang->line('postedcomments') ?></h3>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            ...
                            <!-- /.comment body -->
                            <form method="post" action="<?= base_url('index.php/' . strtolower($this->router->fetch_class()) . "/casehistoryval") ?> ">
